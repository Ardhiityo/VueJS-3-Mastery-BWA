    ...
    <main class="px-4 py-5 my-5 text-center" style="min-height: 50vh;">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <RouterLink :to="{ name: 'register' }" class="btn btn-primary btn-lg px-4 gap-3">Sign up</RouterLink>
                <RouterLink :to="{ name: 'login' }" class="btn btn-outline-secondary btn-lg px-4">Sign in</RouterLink>
            </div>
        </div>
    </main>
</template>